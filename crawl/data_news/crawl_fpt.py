...
input_file = "../../dataset/link/fpt/"
# Thư mục lưu kết quả crawl chi tiết
output_file = "../../dataset/data/fpt"
...
def crawl_article(url):
    ...
    # --- Tiêu đề ---
    title_tag = soup.find("h1", class_="news-short-infor-title field-title")
    title = title_tag.get_text(strip=True) if title_tag else ""

    # --- Ngày đăng ---
    date_tag = soup.find("p", class_="news-short-infor-created-at")
...
if __name__ == "__main__":
    process_files("../../dataset/link/fpt/", "../../dataset/data/fpt")
