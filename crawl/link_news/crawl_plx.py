...
class PetrolimexCrawler:
    def __init__(self, start_page=1, end_page=1, output_dir="../dataset/link/plx"):
        self.base_url = "https://www.petrolimex.com.vn/nd/tin-chuyen-nganh/"
    ...
    def save_page_data(self, articles, page_num):
        ...
        filename = f"plx_page_{page_num}.json"
...
def main():
    # ✅ Bạn chỉnh số trang ở đây
    start_page = 66
    end_page = 130

    crawler = PetrolimexCrawler(start_page=start_page, end_page=end_page)
    crawler.crawl()
