...
output_dir = "../dataset/link/dnh/"
os.makedirs(output_dir, exist_ok=True)

BASE_URL = "https://www.dhd.com.vn/c3/vi-VN/news-lf/Tin-Cong-ty-DHD-1-702?page={}"
            ...
            results.append(
                {
                    ...
                    "url": "https://www.dhd.com.vn" + a_tag["href"],
...
if __name__ == "__main__":
    main(max_pages=45)  # crawl thử 10 trang
